...
task :merge do
  ...
  chapters << " elements/elements.md elements/link.md elements/img.md elements/button.md elements/collections.md elements/nested.md about_extended.md" if type == :paid
